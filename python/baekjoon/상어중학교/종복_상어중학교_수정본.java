...
class BlockGroup implements Comparable<BlockGroup>{
    ...
    if(this.cnt == cmp.cnt){
            if(this.rainbowCnt == cmp.rainbowCnt){
                if(this.standardBlockRow == cmp.standardBlockRow){
                    return cmp.standardBlockCol - this.standardBlockCol;
                }else{
                    return cmp.standardBlockRow - this.standardBlockRow;
                }
            }else{
                return cmp.rainbowCnt-this.rainbowCnt;
            }
        }else{
            return cmp.cnt-this.cnt;
        }
...
public class Main {
    ...
    */
    ...
    public static void main(String args[]) {
      ...
      // System.out.println("첫번째 gravity 후는?");
      // T.print2();
      ...
      // System.out.println("두번째 gravity 후는?");
      // T.print2(); 
