...
public class Main {
    ...
    public static void dfs2(int x, int y, int dir, int length, int lengthCnt, int stage, int pos){
        
          if(pos == finalMarbles.size() || pos == (N*N)){
              return; 
          }
          ...
          int nx = x + dx[dir-1];
          int ny = y + dy[dir-1];
          map[nx][ny] = finalMarbles.get(pos);
          
          dfs2(nx, ny, dir, length, lengthCnt+1, stage, pos+1);
